...
public class OAuth2AuthorizationTest extends TestCase {
    ...
    public void setUp() {
        ...
        oauth2Authorization = new OAuth2Authorization(mockFactory);
    }
    ...
    public void testBuildAuthorizationUrlWithCodeChallengeMethod() {
        ...
        try{
            ...
            // When
            String actual = oauth2Authorization.buildAuthorizationAccessURL(
                    clientId, clientSecret, redirectUri,code, codeVerifier);
            HttpURLConnection result = oauth2Authorization.getUrlConnection(
                    tokenEndpoint,
                    actual,
                    "POST",
