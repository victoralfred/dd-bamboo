package com.ddlabs.atlassian.controller.http;
...
public class DefaultHttpClient implements HttpClient {
    ...
    @Override
    public String get(APIAuthenticationType APIAuthenticationType) throws ApiException {
        String fullUrl = APIAuthenticationType.getEndpoint() + "/api/v1/validate";
        try {
            HttpsURLConnection connection = openConnection(fullUrl, "GET");
            connection.setRequestProperty("DD-API-KEY",  APIAuthenticationType.getApiKey());
            connection.setRequestProperty("DD-APP-KEY", APIAuthenticationType.getAppKey());
    ...
    @Override
    public void post(String url, String seriesPoint, String contentType, String apiKey, String appKey) throws ApiException {
        try{
            HttpsURLConnection connection = openConnection(url, "POST");
            //@todo: Do not commit this hardcoded API keys to the repository
            connection.setRequestProperty("Content-Type", contentType);
            connection.setRequestProperty("DD-API-KEY",  apiKey);
            connection.setRequestProperty("DD-APP-KEY", appKey);
